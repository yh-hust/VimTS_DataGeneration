...
def get_opts():
    ...
    # General Setttings
    parser.add_argument('--video_dir', type=str, default='/home/yl/video_data/codef2',
                        help='video directory')
    parser.add_argument('--output_dir', type=str, default='./result5',
                        help='video directory')
    parser.add_argument('--root_dir', type=str, default='all_sequences/6kZb7DJE1MA_1/6kZb7DJE1MA_1',
                        help='root directory of dataset')
    parser.add_argument('--model_save_path', type=str, default='ckpts/all_sequences/girl2',
                        help='save checkpoint to')
    parser.add_argument('--log_save_path', type=str, default='logs/all_sequences/girl2',
                        help='save log to')
    ...
    parser.add_argument('--flow_dir', type=str,
                        default='all_sequences/girl2/girl2_flow',
    ...
    **********
    ...
    parser.add_argument('--dataset_name', type=str, default='videos',
                        choices=['video'],
    ...
    parser.add_argument('--N_xyz_w', nargs="+", default=[8, 8],
...
def change_opts(hparams_dict,hparams):
    h_dict = vars(hparams)
    params = list(hparams_dict.keys())
    for param in params:
        h_dict[param] = hparams_dict[param]
