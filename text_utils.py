...
class RenderFont(object):
    ...
    def __init__(self, data_dir='data'):
        ...
        #base_book_dir = 'data/newsgroupbook'
        #books_dir = os.listdir(base_book_dir)
        #random_id = random.randint(0,len(books_dir)-1)
        #source = os.path.join('newsgroupbook',books_dir[random_id])
        print(source)
